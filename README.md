...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8oy1yc4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8oy1yc4.containers.anotherwebservice.com/
...
```
git clone git@github.com:davidkonradov-netizen/container-8oy1yc4.git
cd container-8oy1yc4
```
...
```
docker attach container-8oy1yc4
```
